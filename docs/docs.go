...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/system/menuButton/listByMenuIds": {
            "post": {
                "security": [
                    {
                        "LoginToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/system.MenuAndButtonTree"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/system/menuColumn/listByMenuIds": {
            "post": {
                "security": [
                    {
                        "LoginToken": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/system.MenuAndColumnTree"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tools.CreateBucketRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/tools/bucket/delete/batchDelete": {
            "post": {
                "security": [
                    {
                        "LoginToken": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_carefuly_carefuly-admin-go-gin_internal_domain_careful_tools.Bucket"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/tools.BucketListPageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/tools.UpdateBucketRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_carefuly_carefuly-admin-go-gin_internal_domain_careful_tools.Bucket": {
            "type": "object",
            "properties": {
                "belongDept": {
                    "description": "数据归属部门",
        ...
        "github_com_carefuly_carefuly-admin-go-gin_internal_domain_careful_tools.DictType": {
            "type": "object",
            "properties": {
                "belongDept": {
                    "description": "数据归属部门",
                ...
                "dict": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_carefuly_carefuly-admin-go-gin_internal_model_careful_tools.Dict"
                        }
                    ]
                },
                "dictColor": {
        ...
        "github_com_carefuly_carefuly-admin-go-gin_internal_model_careful_tools.Dict": {
            "type": "object",
            "properties": {
                "belongDept": {
                    "description": "数据归属部门",
