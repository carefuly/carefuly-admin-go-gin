...
type Dict struct {
	...
	Type      int    `gorm:"type:tinyint;default:1;index:idx_type;column:type;comment:字典分类" json:"type"`                          // 字典分类
	ValueType int    `gorm:"type:tinyint;default:1;index:idx_value_type;column:valueType;comment:字典值类型" json:"valueType"`         // 字典值类型
}
